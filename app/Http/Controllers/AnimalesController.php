...
class AnimalesController extends Controller
{
    ...
    public function create($id){
        ...
        return view('animales.create', compact('animales', 'especies', 'habitads', 'alimentacion', 'paises', 'IDzoo'));
    }
    ...
    public function edit($id){
        ...
        return view("animales.edit", compact('animal','idAnimal', 'idZoo', 'especies', 'paises', 'habitads', 'alimentacion', 'nacion'));
