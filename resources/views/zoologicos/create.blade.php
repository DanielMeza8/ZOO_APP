                ...
                <div class="card mb-4 mt-4 py-4 text-white" style="max-width: 1500px; background-color: transparent;">
                    <div>
                        <div class="card-body" style="background-color: rgba(217, 217, 224, 0.349);)">
                            ...
                            <h2 class="card-title"><strong>Crear</strong><p><small class="text-muted">"ZOO"</small></p></h2>
                            <form action="{{ route('zoologicos.store') }}" method="post">
                                @csrf
                                @method('POST')
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="direccion" name="direccion" aria-describedby="direccionHelp" required autocomplete="off">
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="telefono" name="telefono" aria-describedby="telefonoHelp" required autocomplete="off">
                                            <div id="telefonoHelp" class="form-text">Ingresa el telefono de comtacto del Zoologico</div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="pais" class="form-label">Estados</label>
                                            <select class="form-select" name="pais" id="pais">
                                                @foreach ($estados as $item)
                                                    <option value="{{$item}}">{{$item}}</option>
                                                @endforeach
                                            </select>
                                            <div id="paisHelp" class="form-text">Ingresa el estado donde se encuentra el Zoologico</div>
                                        </div>
                                    </div>
                                </div>
